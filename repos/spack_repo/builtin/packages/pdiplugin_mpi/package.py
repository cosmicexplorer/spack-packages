...
class PdipluginMpi(CMakePackage):
    ...
    depends_on("pdi@1.10.1", type=("link", "run"), when="@1.10.1")
    depends_on("pdi@1.10.0", type=("link", "run"), when="@1.10.0")
    depends_on("pdi@1.9.3", type=("link", "run"), when="@1.9.3")
    depends_on("pdi@1.9.2", type=("link", "run"), when="@1.9.2")
    depends_on("pdi@1.9.1-fixed", type=("link", "run"), when="@1.9.1-fixed")
